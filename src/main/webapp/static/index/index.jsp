...
<head id="Head1">
    ...
    <link rel="stylesheet" type="text/css" href="${basePath}static/index/js/themes/default/easyui.css" />
    <link rel="stylesheet" type="text/css" href="${basePath}static/index/js/themes/icon.css" />
    <script type="text/javascript" src="${basePath}static/index/js/jquery-1.4.2.min.js"></script>
    <script type="text/javascript" src="${basePath}static/index/js/jquery.easyui.js"></script>

	<script type="text/javascript" src='${basePath}static/index/js/outlook2.js'> </script>
