   ...
   <div style="height: 70px; width: 100%;">
		<form id="ff" method="post">
			...
			<div style="float: left; padding: 20px 0 0 20px;">
				<label for="userName">小区:</label> 
				<input class="easyui-textbox" type="text" name="villageName" />
			</div>
			 <div style="float: left; padding: 20px 0 0 20px;">
				<label for="userid">店名:</label> 
				<input class="easyui-textbox" type="text" name="storeName"  /> 
			</div>
			<div style="float: left; padding: 20px 0 0 20px;">
                <label for="status">类型:</label>
                <input id="typeId" name="typeId" class="easyui-combobox" 
					data-options="valueField:'value',textField:'lable',url:'common/initSysData/${STORETYPE}'">
            </div>
			<div style="float: left; padding: 20px 0 0 20px;">
				<label for="userName">联系人:</label> 
				<input class="easyui-textbox" type="text" name="applicationName" />
			</div>
			 <div style="float: left; padding: 20px 0 0 20px;">
				<label for="userid">电话:</label> 
				<input class="easyui-textbox" type="text" name="contactNumber"  /> 
			</div>		
			<div style="float: left; padding: 20px 0 0 20px;">
    ...
    <table id="dg"  class="easyui-datagrid" style="height: 620px;"
            url="cooperationApplication/findAll" 
        ...
        <thead>
            <tr>
                ...
                <th field="storeAdress" width="100">店铺地址</th>
                <th field="applicationName" width="50" >联系人</th>
                <th field="contactNumber" width="50">电话</th>
                <th field="typeName" width="50">经营种类</th>
                <th field="size" width="50">经营面积</th>
                <th field="applicationDate" width="50" formatter="conversion">申请日期</th>
            </tr>
        </thead>
    </table>
    <div id="toolbar">
