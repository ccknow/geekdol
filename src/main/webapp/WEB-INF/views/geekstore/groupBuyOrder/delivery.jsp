	...
	<div class="ftitle"></div>
        <form id="fm" method="post" novalidate style="height: 100px; width: 100%;">
            ...
            <label for="status">快递公司:</label>
                <input id="deliveryMode" name="deliveryMode" required="true" class="easyui-combobox" 
					data-options="valueField:'value',textField:'lable',editable:false,url:'common/deliveryModel/${EXPRESS}'">
        	</div>
        	<div class="fitem">
                <label>快递单号:</label>
                <input name="logisticsNumber" class="easyui-textbox" required="true">
            </div>        	       
        </form>
...
var url = "";
function optSubmit(){
	var url= "groupBuyOrder/shippingSave/"+id;
	var deliveryMode = $('#deliveryMode').combobox('getValue');
	if(deliveryMode=='0'||deliveryMode==""){
		var res = "请选择快递公司";
		$.messager.show({
         title: 'Error',
         msg: res
