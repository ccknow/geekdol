   ...
   <div style="height: 70px; width: 100%;">
	...
	<input name="DTK" id="DTK" type="hidden" value="${DTK}">
     ...
     <table id="dg"  class="easyui-datagrid" style="height: 620px;"
            url="groupBuyOrder/findAllSupplier" 
    ...
    <div id="toolbar">
        ...
        <shiro:hasPermission name="GrouponOrder:manager">	       
        	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-delivery" plain="true" onclick="delivery()">发货</a>        	
        	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-returnGood" plain="true" onclick="returnGood()">处理退货</a>
        	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-refund" plain="true" onclick="refund()">退款</a>
        	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-close" plain="true" onclick="closeOrder()">关闭</a>       	
        </shiro:hasPermission>
    </div>
    <div id="toolbar">
