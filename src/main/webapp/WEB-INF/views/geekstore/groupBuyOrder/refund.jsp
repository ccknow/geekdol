...
<body>
	<div class="ftitle"></div>
        <form id="fm" method="post" novalidate style="height: 100px; width: 100%;">
			<div class="fitem">
                <label>退款金额:</label>
                <input name="returnMoney" class="easyui-numberbox" precision="2" required="true" style="width: 180px;">
            </div>
            <div class="fitem">
                <label>备注:</label>
                <textarea  name="returnMoneyMark" class="easyui-validatebox" required="true" style="height:50px; width: 500px"></textarea>
            </div>          
        </form>
...
var url = "";
function optSubmit(){
	var url= "groupBuyOrder/refundSave/"+id;
    $('#fm').form('submit',{
        url: url,
        onSubmit: function(){
