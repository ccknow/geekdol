...
<body>
    <div class="ftitle"></div>
        <form id="fm" method="post" novalidate enctype="multipart/form-data">
            ...
            <div class="fitem">
                <label>标题:</label>
                <input name="title" class="easyui-textbox" data-options="disabled:true,required:true,validType:['isBlank','length[1,100]']" style="width:600px">
            </div>
           ...
           <div class="fitem">
                <label>来源:</label>
                <input name="source" class="easyui-textbox" data-options="disabled:true,required:true,validType:['isBlank','length[1,100]']">
            </div>
...
{  
     ...
     //清空小区值(转发需要发给自己所管辖的小区)
     $("#villageName").textbox('setValue',"");
...
function optSubmit(publishStatus){
    ...
    $('#fm').form('submit',{
        url: "intimateNews/zhuanfaIntimateNews",
        onSubmit: function(){
