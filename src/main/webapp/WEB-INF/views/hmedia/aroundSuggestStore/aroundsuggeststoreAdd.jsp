...
<body>
    <form id="fm" method="post" novalidate enctype="multipart/form-data">
        ...
        <div class="div_fitem_1">
			...
			<input id="storeType" name="storeType" class="easyui-combobox" 
				data-options="editable:false,required:true,valueField:'value',textField:'lable',url:'common/initSysDataNoAll/${STORETYPE}'">
        </div>
        <div class="div_fitem_1">
    ...
    <div id="village_dlg" class="easyui-dialog village_choose"
...
function optSubmit(){
    ...
    $('#fm').form('submit',{
        url: "aroundSuggestStore/saveAroundSuggestStore",
        onSubmit: function(){
