...
<body>
   ...
   <div style="height: 100px; width: 90%;">
    ...
    <table id="dg" class="easyui-datagrid" style="height: 620px;"
    		url="heartBeat/selectCommentReply?heartCommentId=${id}"
	...
	<script type="text/javascript">
	   ...
	   //返回上个页面
	    function  fanhui(){
	    	//window.history.go(-1);
            parent.$('#dlg').dialog('open').dialog('setTitle','随心拍评论管理');
            parent.$('#addUserFormUI').attr("src","heartBeat/toComment/"+'${hbId}');
	    }
        ...
        function deleteCommentReply() {
            ...
            if (row){
                $.messager.confirm('提示','确定要删除吗?',function(r){
                    if (r){
                        $.post('heartBeat/deleteCommentReply',{id:row.id,delFlag:'1'},function(result){
