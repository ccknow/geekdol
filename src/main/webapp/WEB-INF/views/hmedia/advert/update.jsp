...
<body>
    ...
    <form id="fm" method="post" novalidate enctype="multipart/form-data">
     <div class="div_fitem_1">
        ...
        <input id="advertCode" name="advertCode"  class="easyui-textbox" data-options="required:true,validType:['isBlank','engAndNum','length[1,20]']">
     </div>
     <div class="div_fitem_1"> 
        <label class="lable_add">广告位置:</label> 
        <input id="positionName" name="positionName" class="easyui-textbox"  editable="false" data-options="required:true,validType:'isBlank'">
     ...
     <div class="div_fitem_1">
         ...
         <input  name="advertOwner" class="easyui-textbox" data-options="required:true,validType:['isBlank','cnennum','length[1,100]']">
     </div>
     <div class="div_fitem_1">
         <label class="lable_add">总金额:</label> 
         <input  name="advertMoney" class="easyui-numberbox" precision="0" min="0" data-options="required:true,validType:'isBlank'">
     </div>
     <div class="div_fitem_1">
         <label class="lable_add">联系人:</label>
         <input  name="advertContacts" class="easyui-textbox" data-options="required:true,validType:['isBlank','inputCnEn','length[1,20]']">
     </div>
     <div class="div_fitem_1">
         <label class="lable_add">联系电话:</label> 
         <input  name="contactNumber"  class="easyui-textbox"data-options="required:true,validType:'isBlank',validType:'phoneRex'">
     </div>   
      <div class="div_fitem_1">
         <label class="lable_add">开始时间:</label>
         <input class="easyui-datebox" type="text" id="startTimeStr" name="startTimeStr" style="width: 150px;" required="true" editable="false"/>
      </div>
      <div class="div_fitem_1">
         <label class="lable_add">结束时间:</label> 
         <input class="easyui-datebox" type="text" id="endTimeStr" name="endTimeStr"  style="width: 150px;" required="true" editable="false"/>
      </div>  
      <div class="div_fitem_1">
          <label class="lable_add">显示顺序:</label>
          <input name="ordering"  class="easyui-numberbox">
      </div>
      <div class="div_fitem_1">
      ...
      <div class="div_fitem_1" style="width: 100%;">
                <input type="radio" id=adverType name="adverType" value="1" hidden="true">
                <label hidden="true">图片广告</label>
                <label class="lable_add" style="width: 13%;">广告图片:</label>
                <input style="width: 190px;" name="file" type="text" id="file1"  class="easyui-filebox" >
                <img id="adverPic" src=""  width="80px" height="80px" onclick="showPic(this)" style="cursor: pointer;"/>
       ...
       <div class="div_fitem_1" style="width:100%;">
                ...
                <input type="radio" name="linkType" value="4" checked="checked"><label for="linkType">网址</label>
                 &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="div_fitem_1">
                ...
                <%-- <input type="radio"  name="linkType" value="1"><label for="linkType">图片</label>
                &nbsp;&nbsp;&nbsp;&nbsp;
                 <input   style="width: 190px;" name="file" id="file2" type="text" class="easyui-filebox">
                <!--  <span style="color: red;">图标：<img id="tubiao1"  width="40px" height="40px"  onclick="showPic(this)"/></span> -->
                <c:if test="${advertVo.linkType == '1'}">
                	<img id="linkContenturl" src=""  width="80px" height="80px" onclick="showPic(this)" style="cursor: pointer;"/>
                </c:if>
       </div>
       <div class="fitem">
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 
               <input type="radio"  name="linkType" value="2"><label for="linkType">Html</label>
                &nbsp;&nbsp;&nbsp;
               <input style="width: 190px;" name="file" id="file3" type="text" class="easyui-filebox">
       </div>
       <div class="fitem"> 
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <input type="radio" name="linkType" value="3"><label for="linkType">视频</label>
                 &nbsp;&nbsp;&nbsp;&nbsp;
                 <input   style="width: 190px;" name="file" id="file4" type="text" class="easyui-filebox">
                 <c:if test="${advertVo.linkType == '3'}">
                 	<br>
                 	<video width="320" height="240" controls>
					  <source id="mp4src" src="" type="video/mp4">
					  <source id="oggsrc" src="" type="video/ogg">
					  <source id="webmsrc" src="" type="video/webm">
					  <object id="vsrc" data="" width="320" height="240">
					    <embed id="swfsrc" src="" width="320" height="240">
					  </object> 
					</video>
                </c:if>
       </div>
       <div class="fitem">   
                &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <input type="radio" name="linkType" value="4"><label for="linkType">网址</label>
                 &nbsp;&nbsp;&nbsp;&nbsp;
                <input id="linkContenturl" name="urlString" class="easyui-textbox" style="width:190px" data-options="validType:'web'" >
      </div>      --%>
    
     <input name="id" id="id" hidden="true" value="${id}">
     <input id="type" hidden="true" value="${advertVo.linkType}">
...
function optSubmit(){
	$.ajax({
   		...
   		dataType:"json",
   		data:{"advertCode":$('#advertCode').textbox('getValue'), "id":$('#id').val()},
   		async:false,
   		success: function(result){
       		if (result.type=='Error'){
            	...
            	$('#startTime').val($('#startTimeStr').datebox('getValue'));
                $('#endTime').val($('#endTimeStr').datebox('getValue'));
                var startTime = $('#startTimeStr').datebox('getValue');
                var endTime = $('#endTimeStr').datebox('getValue');
...
$('#fm').form('load','advert/findById/'+id+"?t="+new Date().getTime());
//回调函数
...
{    
      //显示图片
       ...
       var res=iconString.split(",");    
       for(var i=0;i<res.length;i++){
           $("#tubiao"+i).attr("src",result[i]); 
           
           alert($("#tubiao"+i).val());
        } */
       $("#adverPic").attr("src",data.adverPic);
        /* var linkType = "${advertVo.linkType}";
        if (linkType == '1') {
        	$("#linkContenturl").attr("src",data.linkContenturl);
        } else if (linkType == '3') {
        	$("#mp4src").attr("src",data.linkContenturl);
        	$("#oggsrc").attr("src",data.linkContenturl);
        	$("#webmsrc").attr("src",data.linkContenturl);
        	$("#vsrc").attr("data",data.linkContenturl);
        	$("#swfsrc").attr("src",data.linkContenturl);
        } */
}
