        ...
        <form id="fm" method="post" novalidate style="height: 100px; width: 100%;">
            ...
            <div class="div_fitem_1">
               <label class="lable_add">所属省:</label>
                <input id="provinceId" name="provinceId" value="" class="easyui-combobox" style="width: 100px;" required="true">
            </div>
            <div class="div_fitem_1">
            <label class="lable_add">所属市:</label>
            <input id="cityId" name="cityId" value="" class="easyui-combobox" style="width: 100px;" required="true">
            </div>
            <div class="div_fitem_1">
            <label for="countyId" class="lable_add">所属区:</label>
            <input id="countyId" name="countyId" value="" class="easyui-combobox" required="true" style="width: 100px;">
        </div>
        </form>
</body>
