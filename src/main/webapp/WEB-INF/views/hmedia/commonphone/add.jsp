        ...
        <form id="fm" method="post" novalidate style="height: 100px; width: 100%;">
            <div class="div_fitem_1">
             ...
             <div class="div_fitem_1">
              ...
              <input id="phoneNumber" name="phoneNumber" class="easyui-textbox" data-options="validType:'phoneRex',required:'true',validType:'isBlank'">
            </div>
...
var url= "commonphone/saveCommonPhone";
