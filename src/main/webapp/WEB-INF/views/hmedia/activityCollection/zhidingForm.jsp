...
<body>
    <div class="ftitle"></div>
        <form id="fm" method="post" novalidate >
            ...
            <div class="fitem">
                  <label >置顶开始时间:</label> 
                  <input class="easyui-datetimebox" type="text" id="topStartStr" name="topStart" style="width: 150px;" editable="false" required="true"/>
            </div>
            
            <div class="fitem">
                <label >置顶结束时间:</label>
                <input class="easyui-datetimebox" type="text" id="topEndStr" name="topEnd" style="width: 150px;" editable="false" required="true"/>
            </div>
...
$('#fm').form('submit',{
    url: "activityCollection/zhidingActivity",
    onSubmit: function(){
