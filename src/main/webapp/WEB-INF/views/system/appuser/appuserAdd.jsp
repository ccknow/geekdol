    ...
    <form id="fm" method="post" novalidate>
        <div class="div_fitem_1">
         ...
         <div class="div_fitem_1">
            ...
            <input id="moblie" name="moblie" class="easyui-textbox" data-options="validType:'phoneRex'" required="true" >
        </div>
        <div class="div_fitem_1">
        ...
        <div class="div_fitem_1">
            ...
            <input id="staffLevel" name="staffLevel" class="easyui-combobox" required="true"
