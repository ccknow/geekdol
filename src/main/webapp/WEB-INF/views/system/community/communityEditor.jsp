...
<body>
    ...
    <form id="fm" method="post" novalidate>
        <div class="div_fitem_1">
            <label class="lable_add">社区编码:</label>
            <input name="communityCode" class="easyui-textbox" data-options="required:true,validType:'isBlank',validType:'engAndNum'">
        </div>
         <div class="div_fitem_1">
            <label class="lable_add">社区名称:</label>
            <input name="communityName" class="easyui-textbox" data-options="required:true,validType:'isBlank',validType:'hanzi'">
        </div>
        <div class="div_fitem_1">
            <label class="lable_add">所属省:</label>
            <input id="provinceId" name="provinceId" class="easyui-combobox" 
				data-options="valueField:'provinceId',textField:'provinceName',url:'common/initProvinceQY'" data-options="required:true">
        </div>
        <div class="div_fitem_1">
            <label class="lable_add">所属市:</label>
            <input id="cityId" name="cityId" class="easyui-combobox" 
            data-options="valueField:'cityId',textField:'cityName',url:'common/getCityByProviceQY/${provinceId}'" data-options="required:true">
        </div>
        <div class="div_fitem_1">
            <label class="lable_add">所属区:</label>
            <input id="countyId" name="countyId" class="easyui-combobox" 
            data-options="valueField:'countyId',textField:'countyName',url:'common/getCountryByCityQY/${cityId}'" data-options="required:true">
        </div>
        <div class="div_fitem_1">
        ...
        <input name="communityId" id="communityId" type="hidden" value="${id}">
    </form>
</body>
<script type="text/javascript">
var url= "community/updateCommunity";
function optSubmit(){
...
$('#fm').form('load','community/findById/'+id+"?t="+new Date().getTime());
