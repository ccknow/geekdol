...
<body>
        ...
        <div style="width: 100%; display: inline-block;">
        	<div class="div_fitem_1">
              <label class="lable_add" style="height:auto;">标题:</label>
              ${title }
            </div>
            <div class="div_fitem_1">
            ...
            <div class="div_fitem_1" style="width:100%;">
              ...
              <input id="verifySug" name="verifySug" class="easyui-textbox" data-options="required:true,multiline:true,validType:['isBlank','length[1,253]']" value="" style="width:74%;height:100px">
            </div>
        </form>
</body>
