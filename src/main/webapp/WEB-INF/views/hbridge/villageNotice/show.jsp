    ...
    <div class="ftitle"></div>
        <form id="fm" method="post" novalidate style="height: 100px; width: 100%;">
            ...
            <div id="cityDiv" class="div_fitem_1" style="display:none;">
                  ...
                  <input id="cityId" name="cityId" class="easyui-combobox" style="width: 150px;" disabled = "true">
            </div>
            <div id="countyDiv" class="div_fitem_1" style="display:none;">
                  <label class="lable_add" for="status">区县:</label> 
                  <input id="countyId" name="countyId" class="easyui-combobox" style="width: 150px;" disabled = "true">
            </div>
            <div id="communityDiv" class="div_fitem_1" style="display:none;">
                  <label class="lable_add" for="status">社区:</label>
                  <input id="communityId" name="communityId" class="easyui-combobox" style="width: 150px;" disabled = "true">
            </div>
            <div class="div_fitem_1">
              <label class="lable_add" for="noticeTimeStr">公告落款时间:</label> 
              <input class="easyui-textbox" type="text" value="${noticeTime }" disabled = "disabled"/>
            </div>
            <div class="div_fitem_1" style="width:100%;display:flex;">
              <label class="lable_add" style="width:13%;">置顶:</label>
              <input id="topFlag" name="topFlag" value="0" type="hidden" />
              <input id="topFlagRadio" type="checkbox" value="" disabled="disabled"/>
              <div id="topFlagDiv" style="display:none;width:80%;">
                  <label for="topStartStr" style="margin-left:5%;">置顶开始时间:</label> 
                  <span>${topStart }</span>
                  <label for="topEndStr" style="margin-left:5%;">置顶结束时间:</label> 
                  <span>${topEnd }</span>
              </div>
            </div>
            <div class="div_fitem_1" style="width:100%;position:relative;">
		        ...
		        <div style="margin-left:13%;width:78%;height:200px;position:absolute;">
		        	${content}
		        </div>
		    </div>
        </form>
