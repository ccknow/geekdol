...
<body>
    <form id="fm" method="post" novalidate enctype="multipart/form-data">
        ...
        <div class="div_fitem_1">
           	...
           	<input id="newsTime" name="newsTime" class="easyui-datetimebox" required="true" style="width: 150px;" editable="false">
        </div>
        <!-- <div class="div_fitem_1">
        ...
        <div class="div_fitem_1" style="width: 100%">
            ...
            <input id="picturefile" name="file" class="easyui-filebox" type="text" required="true">
...
function optSubmit(val){
    ...
    $('#fm').form('submit',{
        url: "netizenSecurity/saveNetizenSecurity/"+val,
        onSubmit: function(){
