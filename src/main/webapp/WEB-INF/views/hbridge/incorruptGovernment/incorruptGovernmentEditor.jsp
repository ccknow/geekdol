...
<body>
    ...
    <form id="fm" method="post" novalidate enctype="multipart/form-data">
        ...
        <div class="fitem">
            ...
            <input style="width: 537px;" type="text" class="easyui-filebox" id="file1" name="file" data-options="onChange:validateFileType">
        </div>
        <div class="div_fitem_1">
            <label for="type" class="label_Add">类别:&nbsp;&nbsp;&nbsp;</label>
            <input id="type" name="type" class="easyui-combobox" 
					data-options="valueField:'value',textField:'lable',url:'common/initSysData/${INCORRUPTGOVERNMENTTYPE }'" style="width: 150px;">
        </div>
        <div class="div_fitem_1">
            <label for="messageTimeStr" class="label_Add">信息时间:</label>
            <input id="messageTimeStr" name="messageTimeStr" class="easyui-datetimebox" style="width: 150px;" required="required" editable="false">
        </div>
        <div class="div_fitem_1" style="float: right;">
...
<script type="text/javascript">
	...
	$('#fm').form('load','incorruptGovernment/findById/'+id+"?t="+new Date().getTime());
	//回调函数
	function loadsucc(data) {  
		$("#picture1").attr("src",data.pic);
	}  
	//点击打开大图
	...
	function optSubmit(){
	    ...
	    $('#fm').form('submit',{
	        url: "incorruptGovernment/updateIncorruptGovernment",
	        onSubmit: function(){
	        	$("#messageTime").val($("#messageTimeStr").val());
