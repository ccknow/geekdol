...
public class Goods extends CommonEntity{
    ...
    /**扩展信息*/
    public List<GoodsExtendInfor> goodsExtendInfors;
	...
	public List<GoodsExtendInfor> getGoodsExtendInfors() {
		return goodsExtendInfors;
	}

	public void setGoodsExtendInfors(List<GoodsExtendInfor> goodsExtendInfors) {
		this.goodsExtendInfors = goodsExtendInfors;
	}
}