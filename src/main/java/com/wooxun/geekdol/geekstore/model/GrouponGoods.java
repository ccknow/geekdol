...
public class GrouponGoods extends CommonEntity{
    ...
    /**发布店面*/
    private List<GrouponVillage> grouponVillage;
	...
	public List<GrouponVillage> getGrouponVillage() {
		return grouponVillage;
	}

	public void setGrouponVillage(List<GrouponVillage> grouponVillage) {
		this.grouponVillage = grouponVillage;
	}
}