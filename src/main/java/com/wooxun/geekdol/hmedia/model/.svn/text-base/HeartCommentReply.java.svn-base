...
public class HeartCommentReply extends CommonEntity {
     ...
     * 获取  随心拍评论id
     *
     * @return  heartCommentId
     */
    public Long getHeartCommentId() {
        return heartCommentId;
    }
     ...
     * 设置  随心拍评论id
     *
     * @param heartCommentId
     */
    public void setHeartCommentId(Long heartCommentId) {
        this.heartCommentId = heartCommentId;
    }
