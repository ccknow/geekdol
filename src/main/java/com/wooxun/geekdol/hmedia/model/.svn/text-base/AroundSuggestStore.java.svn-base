...
*==========================================================
* No    修改人员			修改日期  	   			描述
* 1. 	 Administrator	2016年8月1日  上午9:04:41 		创建
*==========================================================
*
 */
public class AroundSuggestStore extends CommonEntity {
    /**
	 * 
	 */
    ...
    /** 推荐方式:1推荐店新增,2周边店本网格推荐,3.别的网格长荐给我（周边店推荐）
            4.别的网格长荐给我（推荐店）
             */
    private String suggestType;

    /** 根据推荐方式和来源数据id可以查询出该数据的源头 */
    ...
    /** 对应的促销信息 */
    private List<AroundSuggestStorePromotion> promotionList;
   ...
   public void setHoursStart(String hoursStart) {
       this.hoursStart = hoursStart == null ? null : hoursStart.trim();
   }
   ...
   public void setHoursEnd(String hoursEnd) {
       this.hoursEnd = hoursEnd == null ? null : hoursEnd.trim();
   }
   ...
   /**
    *
    * 获取  推荐方式:1推荐店新增,2周边店本网格推荐,3.别的网格长荐给我（周边店推荐）
           4.别的网格长荐给我（推荐店）
   ...
   /**
    *
    * 设置  推荐方式:1推荐店新增,2周边店本网格推荐,3.别的网格长荐给我（周边店推荐）
           4.别的网格长荐给我（推荐店）
   ...
   public void setSuggestFlag(String suggestFlag) {
	...
	public List<AroundSuggestStorePromotion> getPromotionList() {
		return promotionList;
	}
	
	public void setPromotionList(List<AroundSuggestStorePromotion> promotionList) {
