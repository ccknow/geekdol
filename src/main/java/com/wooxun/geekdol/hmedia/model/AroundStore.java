...
*==========================================================
* No    修改人员			修改日期  	   			描述
* 1. 	 Administrator	2016年8月2日  上午11:40:48 		创建
*==========================================================
*
 */
public class AroundStore extends CommonEntity{
	...
	/** 周边店与小区关系 */
    public List<AroundStoreVillage> aroundStoreVillage;
    ...
    public List<AroundStoreVillage> getAroundStoreVillage() {
		return aroundStoreVillage;
	}

	public void setAroundStoreVillage(List<AroundStoreVillage> aroundStoreVillage) {
		this.aroundStoreVillage = aroundStoreVillage;
	}
