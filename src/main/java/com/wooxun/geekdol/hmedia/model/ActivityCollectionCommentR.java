...
public class ActivityCollectionCommentR extends CommonEntity {
	/**
	 * 
	 */
	 ...
	 * @param inCommentId
	 */
	public void setInCommentId(Long inCommentId) {
		this.inCommentId = inCommentId;
	}
