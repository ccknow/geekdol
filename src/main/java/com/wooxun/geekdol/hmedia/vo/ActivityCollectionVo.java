 ...
 *
 */
public class ActivityCollectionVo extends BaseVo {
	...
	public String getEnrollEndStr() {
		return enrollEndStr;
	}

	public void setEnrollEndStr(String enrollEndStr) {
		this.enrollEndStr = enrollEndStr;
	}
