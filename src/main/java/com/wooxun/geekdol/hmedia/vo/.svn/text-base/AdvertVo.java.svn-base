...
public class AdvertVo extends BaseVo{
    ...
    private List<AdvertVillage> advertVillageList;
    ...
    public void setAdvertContacts(String advertContacts) {
        this.advertContacts = advertContacts;
    }
    ...
    public void setLinkContenturl(String linkContenturl) {
        this.linkContenturl = linkContenturl;
    }
    ...
    public List<AdvertVillage> getAdvertVillageList() {
        return advertVillageList;
    }

    public void setAdvertVillageList(List<AdvertVillage> advertVillageList) {
        this.advertVillageList = advertVillageList;
    }
