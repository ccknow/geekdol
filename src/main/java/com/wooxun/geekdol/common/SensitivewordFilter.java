...
public class SensitivewordFilter {
	@SuppressWarnings("rawtypes") Map sensitiveWordMap = null;
	...
	public SensitivewordFilter(){
		sensitiveWordMap = new SensitiveWordInit().initKeyWord(null);
	}
	...
	public static void main(String[] args) {
		...
		String string = "吉客多垃圾太多的伤感情怀也许只局限于饲养基地 荧幕中的情节，主人公尝试着去用某种方式渐渐的很潇洒地释自杀指南怀那些自己经历的伤感。"
