...
public class LoginController {
	...
	private static final String TOREPASSWD = "repasswd";
	private static final String LOGINOUT = "login";
	
	@Autowired
	private UserService<User> userServic;
	...
	String timeoutSuccess() {
	    //logSysService.addLog(ConstantStr.LOG_TYPE_LOGIN, this.getLoginId().toString(), ConstantStr.LOG_LEAVEL_INFO);
	...
	@RequestMapping(value = "/repasswd", method = {RequestMethod.GET})
	public String toRepasswd() {
		return TOREPASSWD;
	}
	
	@RequestMapping(value = "/repasswd/reset", method = {RequestMethod.GET,RequestMethod.POST})
	public @ResponseBody String repasswd(String userName,String email,String phone) {
		return "";
	}
